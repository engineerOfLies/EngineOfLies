...
"""
Name: 'Engine of Lies (.eolmesh)...'
Blender: 249
Group: 'Export'
Tooltip: 'Save an engine of lies mesh File'
"""

__author__ = "Engineer of lies"
__url__ = ['https://github.com/engineerOfLies/EngineOfLies']
__version__ = "0.1"

__bpydoc__ = """\
This script is an exporter to the Engine of Lies mesh import format
...
#
#   Based on the original obj exporter by Campbell Barton, Jiri Hnidek, Paolo Ciccone
...
EXPORT_TRI=True,  EXPORT_EDGES=True,  EXPORT_NORMALS=True,  EXPORT_NORMALS_HQ=True,\
EXPORT_UV=True, EXPORT_VGROUPS=True,  EXPORT_APPLY_MODIFIERS=True, EXPORT_ROTX90=True,\
